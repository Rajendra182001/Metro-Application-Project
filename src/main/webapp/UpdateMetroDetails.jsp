    ...
    <div class="card mx-auto" style="max-width: 700; max-height:1000;border-radius: 15px; overflow: hidden;>
        ...
        <div class="card" >
            ...
            <div class="card-body" style="background-color: black;">
                ...
                <input type="email" id="email" name="email" value="${dto.email}" hidden>
                    <div class="mb-3">
                        <label for="addTrainId" class="form-label" hidden>addTrainId</label>
                        <input type="number" class="form-control" id="addTrainId" name="addTrainId" value="${ato.addTrainId}" hidden>
                    </div>
                    <div class="mb-3">
                        <label for="trainNumber" class="form-label"   style="color:white">trainNumber</label>
                        <input type="text" class="form-control" id="trainNumber" name="trainNumber" value="${ato.trainNumber}">
                    </div>
                    <div class="mb-3">
                   <label for="trainType" class="form-label"   style="color:white">trainType</label>
                  <input type="text" class="form-control" id="trainType" name="trainType" value="${ato.trainType}">
                  </div>
          <div class="mb-3">
             <c:forEach items="${ato.timingEntity}" var="timing">
        ...
        <input type="text" class="form-control" id="destination" name="destination" value="${timing.destination}">
          ...
          <div class="mb-3">
             <c:forEach items="${ato.priceEntity}" var="price">
