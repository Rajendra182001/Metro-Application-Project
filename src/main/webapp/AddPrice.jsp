...
<br>
    ...
    <div style="max-width: 500px; margin: auto;">
       ...
       <div class="col-md-6 mb-1">
                         ...
                         <input type="text"  name="email" id="trainNumber" class="form-control" placeholder="Enter the email" value="${dto.email}" hidden>
                          </div>
                          <div class="mb-3">
                              <label for="source"   style="color:white" class="form-label">Select Source Station</label>
...
<div class="mb-3">
    ...
    <select name="destination" onBlur="destination()" id="destinationId" class="form-control" required>
                ...
                <select name="trainType" id="trainType" class="form-control" required>
                    ...
                    <option value="Green">Green</option>
                        ...
                        <label for="distance"   style="color:white" class="form-label">distance*</label>
                         <input type="text"  name="distance" id="distance" class="form-control " placeholder="Enter the distance">
                         </div>
                         ...
                         <div class="mb-3">
                           ...
                           <div class="mb-3">
                 <label for="stationNumber"   style="color:white" class="form-label">Station Number*</label>
                <input type="number"  name="stationNumber" id="stationNumber" class="form-control" placeholder="Enter the stationNumber">
                  </div>

                           <div class="mb-3">
                 <label for="trainNumber"   style="color:white" class="form-label">Train Number*</label>
                <input type="text"  name="trainNumber" id="trainNumber" class="form-control" placeholder="Enter the Train Number">
                  </div>
