...
<div style="text-align: center;">
        <img src="https://th.bing.com/th?id=OLC.Kj96CPQlp0+sew480x360&rs=1&pid=ImgDetMain" alt="Descriptive Alt Text" class="img-fluid" style="max-height: 500px; max-width: 500px; display: block; margin: auto;">
    </div>
    <h1><i>Information</i></h1>
    <p>Bangalore (Namma) Metro is an urban Mass Rapid Transit System (MRTS) with 2 lines and 51 stations serving Bengaluru, Karnataka’s capital and largest city</p>
    <p>Construction for Bangalore Metro Phase 1 with 42.30 km of routes started in April 2007. Its first section, connecting Baiyyappanahalli – MG Road on the Purple Line, opened up in 2011. The 6th (and final) section was inaugurated by India’s President on June 17, 2017, and commercial operations started on the next day.</p>
    <p>Construction work on the 73.921 km Bangalore Metro Phase 2's first new section (Mysore Road  Pattanagere, Reach-2A of Purple Line) started in September 2015. The project faced funding issues due to which a majority of civil construction contracts were awarded only in the first half of 2017.</p>
    <p>While the Green Line’s extension to Silk Institute became operational in January 2021, the entire phase, including a 13.9 km underground section of the Pink Line, is expected to be ready no sooner than 2024 after which the metro network will become 116.25 km long.</p>
    <p>Bangalore Metro’s Phase 3 project with routes totaling 44.65 km is currently pending approval from the Central Government’s cabinet. Earlier 105 km of routes were planned. From that, 18 km (Central Silk Board – KR Puram) and 38 km (KR Puram – KIAL Airport) of lines have been expedited and are currently being built in parallel with Phase 2 under Phase 2A and Phase 2B respectively.</p>
    ...
    <ul>
        ...
        <li>Rolling Stock: 342 coaches (57 train-sets x 6) supplied by BEML and 216 coaches (36 x 6) to be supplied by CRRC</li>
    </ul>
