...
<h3 style="font-family: 'Arial', sans-serif; text-align: center; margin-right: -237px; margin-top: 35px; font-size: 20px; color: black; letter-spacing: 2px; text-transform: uppercase;">My Account</h3>
        ...
        <b>Login:</b>
            <div class="mb-1">
                <span for="emailId" id="emailLabelId"class="form-label" >User Email*</span>
                    <input type="email"  id="emailId"  onblur="checkEmail()" name="email" placeholder="User@gmail.com" id="emailId" class="form-control"  value="${email.email}"required>
            </div>
                    <div class="col-auto">
                     <button type="submit" name="button" class="btn btn-primary btn-sm rounded-sm border border-light rounded-pill">Get OTP</button>
                     </div>
                    <br>
                    </form>
